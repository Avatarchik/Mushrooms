...
public class characterRotate : MonoBehaviour {
 ...
 void OnGUI() {
	  if (GUI.Button(new Rect(20, 20, 70, 40),"Idle")){
		...
		if (GUI.Button(new Rect(510, 20, 70, 40),"Damage_air")){
		  frog.GetComponent<Animation>().wrapMode= WrapMode.Once;
		  	frog.GetComponent<Animation>().CrossFade("Damage_air");
	  }		
			if (GUI.Button(new Rect(580, 20, 70, 40),"Stun")){
			frog.GetComponent<Animation>().wrapMode= WrapMode.Loop;
		  	frog.GetComponent<Animation>().CrossFade("Stun");
	  } 
		if (GUI.Button(new Rect(20, 65, 70, 40),"Knock_back")){
		  frog.GetComponent<Animation>().wrapMode= WrapMode.Once;
...
//		if (GUI.Button(new Rect(160, 65, 70, 40),"Idle2")){
//		  frog.animation.wrapMode= WrapMode.Loop;
//		  	frog.animation.CrossFade("Idle2");
//	  }
//		if (GUI.Button(new Rect(230, 65, 70, 40),"Idle2")){
//			frog.animation.wrapMode= WrapMode.Loop;
//			frog.animation.CrossFade("Idle2");
//	  }	
